...
**Damage Severity **
<br>
Most of the crash in these two years are property damage accident. Injury accident, property damage & injury accident, and property damage accident have similar distribution through all the time during one day. The proportion of fatal accident is very small, but happened during night and early morning more often. 
```{r fig.width=8, message=FALSE, warning=FALSE, echo=FALSE}
